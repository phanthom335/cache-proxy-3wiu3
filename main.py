    ...
    Cache Proxy 3wiu3
    =================
    Production-ready REST API component built to proxy web requests at scale.
...
return app
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Production-ready REST API component built to proxy web requests at scale.")
